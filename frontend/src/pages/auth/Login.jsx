  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gray-900 text-white p-4">
      <div className="w-full max-w-md p-10 flex flex-col items-center bg-gray-800 rounded-3xl shadow-2xl border border-gray-700">
        <h2 className="text-4xl font-extrabold text-center text-blue-500 tracking-wide mb-8">STOV Voting</h2>
          ...
          <form onSubmit={handleMfaSubmit} className="w-full flex flex-col items-center space-y-6">
            ...
            <div className="w-full text-center">
              ...
              <input
                ...
                required
                maxLength="6"
                className="w-full bg-gray-700 border border-gray-600 rounded-xl py-3 px-4 text-white focus:ring-2 focus:ring-emerald-500 transition-all duration-300 outline-none tracking-[0.75em] text-center text-2xl font-mono font-bold"
                placeholder="000000"
                value={mfaCode}
